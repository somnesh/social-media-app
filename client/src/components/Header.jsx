...
export function Header() {
  ...
  return (
    <header className="flex justify-end sm:justify-normal py-1 pl-3 pr-2 bg-white dark:bg-[#242526] items-center sticky top-0 transition-colors duration-500 shadow-md z-40">
