...
export function Sidebar({ variant, setCurrentPage }) {
  ...
  return (
    <section
      className={`flex sm:flex-col justify-around sm:justify-normal basis-1/4 sm:h-screen lg:sticky top-[4.5rem] overflow-y-auto rounded-md gap-1 sm:max-w-80 transition-transform ${
